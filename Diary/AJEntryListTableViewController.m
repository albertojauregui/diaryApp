//
//  AJEntryListTableViewController.m
//  Diary
//
...
@implementation AJEntryListTableViewController
...
- (NSFetchRequest *)entryListFetchRequest {
    NSFetchRequest *fetchRequest = [NSFetchRequest fetchRequestWithEntityName:@"AJDiaryEntry"];
...
{
    AJEntryCell *cell = [tableView dequeueReusableCellWithIdentifier:@"Cell" forIndexPath:indexPath];
